...
const About = () => {
  return (
    ...
    >
      ...
      <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 px-1">
      ...
      <p className="mt-3 text-base text-gray-500 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0 px-1">
        This hash contains:
        <ul className="list-disc dark:text-gray-400 ml-10 mt-1 text-md">
