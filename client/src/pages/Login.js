...
const Login = () => {
  ...
  return (
    <div className="flex w-screen mt-52 montserrat">
      <p className="p-6 max-w-md rounded-lg border border-gray-200 shadow-xl bg-white mx-auto">
        <h5 className="mb-10 text-2xl font-bold tracking-tight text-gray-900 text-center">
          Login
        </h5>
        {account.data ? (
          <p
            className="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group cursor-pointer"
